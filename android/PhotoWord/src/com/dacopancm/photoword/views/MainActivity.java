...
public class MainActivity extends ActionBarActivity implements
	...
	public boolean onOptionsItemSelected(android.view.MenuItem item) {
		 ...
		 * TemplatesActivity.class); templatesI.putExtra("wordx", "pelota");
		 * templatesI .putExtra( "imgsrc",
		 * "/storage/sdcard/Android/data/com.dacopancm.photoword.views/files/Pictures/tmpPhotoWord.jpg"
		 * ); startActivity(templatesI); return true; }
		 */
		/*
		 * case R.id.tmp_sharex: { // String imageFileName =
		 * Const.PHOTOWORD_FILE_1; File storageDir =
